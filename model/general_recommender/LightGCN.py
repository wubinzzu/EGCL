...
class LightGCN(AbstractRecommender):
    ...
    def build_graph(self):
        ...
        *********************************************************
        ...
        # self.u_g_embeddings   self.pos_i_g_embeddings   self.neg_i_g_embeddings  在计算bpr损失时被用到
        self.u_g_embeddings = tf.nn.embedding_lookup(self.ua_embeddings, self.users)
        self.pos_i_g_embeddings = tf.nn.embedding_lookup(self.ia_embeddings, self.pos_items)
        self.neg_i_g_embeddings = tf.nn.embedding_lookup(self.ia_embeddings, self.neg_items)

        # self.u_g_embeddings_pre  self.pos_i_g_embeddings_pre  self.neg_i_g_embeddings_pre  在计算正则化损失时被用到
    ...
    def _create_lightgcn_embed(self):
        ...
        # self.weights['user_embedding'], self.weights['item_embedding']  初始化的表征
